...
const CourseApiF8 = [
    ...
    "priority": 10,
    "students_count": 59082,
    "created_at": "2020-04-10T14:23:13.000000Z",
    "updated_at": "2021-10-09T11:43:53.000000Z",
    ...
    "level": "Trình độ cơ bản",
    "priority": 30,
    "students_count": 38382,
    "created_at": "2020-06-10T14:23:13.000000Z",
    "updated_at": "2021-10-09T11:44:51.000000Z",
    ...
    "level": "Trình độ cơ bản",
    "priority": 0,
    "students_count": 33379,
    "created_at": "2020-02-10T14:23:13.000000Z",
    "updated_at": "2021-10-09T11:48:09.000000Z",
    ...
    "slug": "nodejs",
    "description": "Học Back-end với Node & ExpressJS framework, hiểu các khái niệm khi làm Back-end và xây dựng RESTful CourseApi cho trang web.",
    ...
    "updated_at": "2021-10-09T11:31:10.000000Z",
    ...
    "students_count": 4907,
    "created_at": null,
    "updated_at": "2021-10-09T11:41:12.000000Z",
    ...
    "updated_at": "2021-10-09T11:41:21.000000Z",
...
function CourseApi() {
    ...
    const CourseItem = ({ course }) => (
      <>
      <img onClick={() => alertTitle(course.title)} src={course.thumbnail_cdn} alt="img" />
      <h3>{course.title}</h3>
      <p>{course.description}</p>
      <p>Số lượng học sinh: {course.students_count}</p>
      </>
  )
    return (
      <div className="boxCourseApi">
      {CourseApiF8.map(course => (
          <CourseItem
              key={course.id}
              course = {course}
          />
